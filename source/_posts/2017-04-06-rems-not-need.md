...
2. Реальная пролема, скажу я вам, в том, что размер текста определен 50(!) раз. И если вы так делаете, вам нужно приводить в порядок типографику на сайте. О, нет! Вы слышите это? Это стук копыт typography nazzi.
...
Теперь, когда это стало очевидным, вы скажете: "О нет, это много повторений, нам нужно сделать это по-другому, любой ценой. но никаких повторений".
...
Не дайте своему сайте потеряться в космосе.
...
Так вот, подумайте о своей типографике, настройте ее один раз, сделайте это в пикселях, справьтесь с небольшим количеством повторений, удостоверьтесь, что размер вашего текста стал именно таким, каким вы хотите, и забудьте о нем.

Эта напущенная статья была гораздо длиннее, но остальное осталось в черновиках и я не стал публиковать их.
...
2. Если вы хотите, чтоб цвет фона полностью заливал вашу страницу по высоте, используйте 100vh вместо 100%. Но, елси вы используете vh, вам следует тщательнее тестировать на реальных iOS устройствах.
